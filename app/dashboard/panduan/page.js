  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in duration-500 max-w-4xl">
      <div className="bg-[#0B0F14] border border-white/5 p-8 rounded-3xl relative overflow-hidden">
        <h1 className="text-3xl font-black mb-2 text-white">📖 Panduan Lunasin.id</h1>
      ...
      <div className="space-y-6">
        ...
        <section className="bg-red-500/10 border border-red-500/20 p-8 rounded-2xl">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            <strong>Jangan pernah gali lubang tutup lubang.</strong> Meminjam pinjol baru untuk menutup pinjol lama adalah awal kehancuran. Gunakan Lunasin.id untuk melakukan restrukturisasi, potong pengeluaran, dan ikuti rencana yang telah dibuatkan oleh sistem.
          </p>
        </section>
      </div>
    </div>
