...
import {
  ...
  CheckCircle2, BarChart3, Bell, MessageSquare,
  ...
  return (
    <div className="min-h-screen bg-[#060A0F] text-white overflow-x-hidden font-sans">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-black/40 hover:scale-110 active:scale-95 transition-transform"
